...
impl SetFlagsType {
    ...
    // delphi/FPC sets
    pub fn define_new(lib: &mut LibraryBuilder, name: Option<&IdentPath>, bit_count: usize) -> Self {
        ...
        let struct_identity = match name {
            Some(ident_path) => {
            ...
            None => {
                ir::StructIdentity::Internal(format!("<{}-bit flags>", bit_count))
            }
        };
